...
2. Mantener el baseline `613175e` y repetir `npm run task:check -- GLORY-BASELINE` después de cada bloque de cambios.
...
- El gate coordinado ya cierra contra el `HEAD` propio `613175e`: `task:check -- GLORY-BASELINE` devuelve PASS.
