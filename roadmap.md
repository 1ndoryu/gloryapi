...
2. Mantener el baseline `509a772` y repetir `npm run task:check -- GLORY-BASELINE` después de cada bloque de cambios.
...
- El gate coordinado ya cierra contra el `HEAD` propio `509a772`: `task:check -- GLORY-BASELINE` devuelve PASS.
