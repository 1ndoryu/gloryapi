...
2. Mantener el baseline `cd2a398` y repetir `npm run task:check -- GLORY-BASELINE` después de cada bloque de cambios.
...
- El gate coordinado ya cierra contra el `HEAD` propio `cd2a398`: `task:check -- GLORY-BASELINE` devuelve PASS.
