...
2. Mantener el baseline `c8e3732` y repetir `npm run task:check -- GLORY-BASELINE` después de cada bloque de cambios.
...
- El gate coordinado ya cierra contra el `HEAD` propio `c8e3732`: `task:check -- GLORY-BASELINE` devuelve PASS.
