...
export function migrateModelsV17(db: Database.Database) {
  const additions: ModelAddition[] = [
    ...
    ['ollama', 'deepseek-v4-pro', 'DeepSeek V4 Pro (Ollama)', 4, 9, 'Frontier', null, null, null, null, '~5-10M', 1048576],
    ...
    ['huggingface', 'deepseek-ai/DeepSeek-V4-Pro', 'DeepSeek V4 Pro (HF)', 4, 9, 'Frontier', null, null, null, null, '~1-3M', 1048576],
